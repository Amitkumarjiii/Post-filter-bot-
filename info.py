...
API_ID = int(environ.get('API_ID', '25700074'))
API_HASH = environ.get('API_HASH', '66539d66b0eb7c32d169038725034126')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5801931353').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '1001912373025').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://amitliteofficial:4T9UH8kWEToMqSrV@cluster0.sdr18vl.mongodb.net/?retryWrites=true&w=majority")
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'ce176148c955a472069674cebc9d421098f1db10')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', True))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/allmovierequestgroupssssss')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Southplex1')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Linkl')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Hello My Dear Friends ❤️')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '1001934894860'))
...
URL = "https://post-filter-bot-cntx.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://post-filter-bot-cntx.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://post-filter-bot-cntx.onrender.com/".format(FQDN)
else:
    URL = "https://post-filter-bot-cntx.onrender.com/".format(FQDN)
